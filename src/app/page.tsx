      ...
      <section className="rounded bg-neutral-100 py-8 sm:py-12">
        <div className="mx-auto  grid grid-cols-2 items-center justify-items-center gap-8 px-8 sm:px-16">
          <div className="max-w-md space-y-4">
            ...
            <Button asChild variant="default bg-enerald-400">
              <Link href="products" className="inline-flex items-center justify-center text-white rounded-full px-6 py-3">Browse All Products</Link>
            </Button>
          </div>
          <Image
            alt="Banner Image"
